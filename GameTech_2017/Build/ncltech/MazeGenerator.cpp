...
void MazeGenerator::GenerateAnditionalData()
{
	if (allNodes)
	{
		delete[] allNodes;
...
void MazeGenerator::GetUserDefineStartEnd(int x1, int y1, int x2, int y2)
{
	start = &allNodes[x1 * size + y1];
	end = &allNodes[x2 * size + y2];
}
